...
public record RainbowStatusPayload(boolean status) implements NetworkingPayloads.ChaosPayload.StatusPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, RainbowStatusPayload> CODEC = PacketCodec.tuple(PacketCodecs.BOOLEAN, RainbowStatusPayload::status, RainbowStatusPayload::new);
