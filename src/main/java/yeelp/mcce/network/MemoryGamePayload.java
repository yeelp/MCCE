...
public record MemoryGamePayload(boolean status) implements NetworkingPayloads.ChaosPayload.StatusPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, MemoryGamePayload> CODEC = PacketCodec.tuple(PacketCodecs.BOOL, MemoryGamePayload::status, MemoryGamePayload::new);
