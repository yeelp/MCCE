...
public final class ChaosEffects {
    ...
    public static final ChaosEffectRegistryEntry AROUND_THE_WORLD;
    public static final ChaosEffectRegistryEntry BACK_TO_SQUARE_ONE;
    public static final ChaosEffectRegistryEntry BAKE;
    ...
    public static final ChaosEffectRegistryEntry CHICKEN_FOUNTAIN;
    public static final ChaosEffectRegistryEntry CHUNKY;
    public static final ChaosEffectRegistryEntry CLICKY;
    public static final ChaosEffectRegistryEntry CLIPPY;
    public static final ChaosEffectRegistryEntry COLOUR_INVERSION;
    ...
    public static final ChaosEffectRegistryEntry FLIPPING_OUT;
    public static final ChaosEffectRegistryEntry FOOD_CHAIN;
    public static final ChaosEffectRegistryEntry GAMMEGA;
    ...
    public static final ChaosEffectRegistryEntry GOING_BIG;
    public static final ChaosEffectRegistryEntry GOTTA_BLAST;
    public static final ChaosEffectRegistryEntry GRAYSCALE;
    public static final ChaosEffectRegistryEntry GRUMMBONE;
    public static final ChaosEffectRegistryEntry HEARTY;
    public static final ChaosEffectRegistryEntry HELP_OR_HINDER;
    public static final ChaosEffectRegistryEntry HOTBAR_ROULETTE;
    public static final ChaosEffectRegistryEntry ICONIC;
    ...
    public static final ChaosEffectRegistryEntry MOSAIC;
    ...
    public static final ChaosEffectRegistryEntry PAINT;
    ...
    public static final ChaosEffectRegistryEntry SOCIAL_DISTANCING;
    public static final ChaosEffectRegistryEntry SOUND;
    public static final ChaosEffectRegistryEntry SPIN_TO_WIN;
    ...
    static {
        ...
        AROUND_THE_WORLD = createRegistryEntry(AroundTheWorldEffect::new);
        BACK_TO_SQUARE_ONE = createRegistryEntry(BackToSquareOneEffect::new);
        BAKE = createRegistryEntry(BakeEffect::new);
        ...
        CHICKEN_FOUNTAIN = createRegistryEntry(ChickenFountainEffect::new);
        CHUNKY = createRegistryEntry(ChunkyEffect::new);
        CLICKY = createRegistryEntry(ClickyEffect::new);
        CLIPPY = createRegistryEntry(ClippyEffect::new);
        COLOUR_INVERSION = createRegistryEntry(ColourInversionEffect::new);
        ...
        FLIPPING_OUT = createRegistryEntry(FlippingOutEffect::new);
        FOOD_CHAIN = createRegistryEntry(FoodChainEffect::new);
        GAMMEGA = createRegistryEntry(GammegaEffect::new);
        ...
        GOING_BIG = createRegistryEntry(GoingBigEffect::new);
        GOTTA_BLAST = createRegistryEntry(GottaBlastEffect::new);
        GRAYSCALE = createRegistryEntry(GrayscaleEffect::new);
        GRUMMBONE = createRegistryEntry(GrummboneEffect::new);
        HEARTY = createRegistryEntry(HeartyEffect::new);
        HELP_OR_HINDER = createRepeatingRegistryEntry(HelpOrHinderEffect::new);
        HOTBAR_ROULETTE = createRegistryEntry(HotbarRouletteEffect::new);
        ICONIC = createRegistryEntry(IconicEffect::new);
        ...
        MOSAIC = createRegistryEntry(MosaicEffect::new);
        ...
        PAINT = createRegistryEntry(PaintEffect::new);
        ...
        POLITE = createRegistryEntry(PoliteEffect::new);
        PRESS_L_TO_LEVITATE = createRegistryEntry(PressLToLevitateEffect::new);
        PUSHY = createRegistryEntry(PushyEffect::new);
        QUIVER = createRegistryEntry(QuiverEffect::new);
        RAVE = createRegistryEntry(RaveEffect::new);
        ...
        ROTATE = createRegistryEntry(RotateEffect::new);
        SCATTER = createRegistryEntry(ScatterEffect::new);
        SCRAMBLED = createRepeatingRegistryEntry(ComponentCompensationEffect::new);
        SEPIA = createRegistryEntry(SepiaEffect::new);
        ...
        SOCIAL_DISTANCING = createRegistryEntry(SocialDistancingEffect::new);
        SOUND = createRepeatingRegistryEntry(SoundEffect::new);
        SPIN_TO_WIN = createRegistryEntry(SpinToWinEffect::new);
